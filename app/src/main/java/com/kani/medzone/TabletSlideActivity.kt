...
class TabletSlideActivity : AppCompatActivity(),ItemClickListener {
    ...
    private  var tabs:ArrayList<TabletEntry>? = ArrayList()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        model.tabEntryList.observe(this,{
            ...
            tabletsNotificationAdapter?.notifyDataSetChanged()
...
//        {
            ...
            try {
                notifcationBody.put("title", "${duration}Tablets Skipped")
